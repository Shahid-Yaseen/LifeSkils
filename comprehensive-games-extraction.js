...
// Comprehensive list of ALL games from each component in games.tsx
const allGamesFromComponents = [
...
async function uploadAllGames() {
  ...
  try {
    console.log('🎮 COMPREHENSIVE GAMES UPLOAD');
    console.log('=============================');
    console.log(`📋 Total games to upload: ${allGamesFromComponents.length}`);
    ...
    // Insert all games
    for (const gameData of allGamesFromComponents) {
      const query = `
    ...
    console.log(`\n🎉 Successfully uploaded ${allGamesFromComponents.length} games!`);
