        ...
        try {
          ...
          if (!voiceExists) {
            ...
            if (fallbackVoice) {
              ...
              const audioUrl = await generateAITTS(text, fallbackVoice.key);
          ...
          const audioUrl = await generateAITTS(text, selectedVoice);
          setAudioUrl(audioUrl);
          onAudioGenerated?.(audioUrl);
          }
          ...
          audio.onerror = (event) => {
            ...
            console.error('Expected audio URL:', absoluteAudioUrl);
